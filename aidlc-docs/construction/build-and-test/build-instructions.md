...
# Single image
uv run python -m src.main --mode image --source training/test_images/Keyboard/Image_1.jpeg

# Batch folder
uv run python -m src.main --mode batch --source training/test_images/   # recursive subfolders
```
...
# Single image
uv run python -m src.main --mode image --source training/test_images/Keyboard/Image_1.jpeg --model models/yolo11n-seg.pt

# Batch
uv run python -m src.main --mode batch --source training/test_images/   # recursive subfolders --model models/yolo11n-seg.pt
```
...
```bash
# Use headless mode:
uv run python -m src.main --mode image --source training/test_images/Keyboard/Image_1.jpeg --no-display
